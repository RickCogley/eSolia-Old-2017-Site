...
<div class="card">
  ...
  <div class="card-reveal">
    ...
    <p>2006年に設立したPBXLは、第2種通信事業者免許取得し、日本でいちはやくクラウド型コミュニケーションサービスを提供するなど、通信ソリューションのパイオニアとして活躍しております。</p><p>PBXLは、高い技術を持つスタッフが丁寧且つきめ細やかな対応で導入から日々のオペレーションサポートを実施及び提供しております。生産性の高いパフォーマンス構築を実現すると伴に、オープンなコラボレーションとモバイルスタッフの力を活用しております。</p>
  </div>
</div>
